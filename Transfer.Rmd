...
transfer.dat = my.dat %>% filter(Time == "00000" & Group %in% c(1,2)) %>%
  ...
  dplyr::rename(ObservationType = ObsType, 
...
my.dat = dplyr::rename(my.dat, Mass = `Mass (g)`)
my.dat = dplyr::rename(my.dat, TransferTime = `TransferTime (s)`)
my.dat = dplyr::rename(my.dat, PersistenceTime = `PersistenceTime (min)`)
#colnames(my.dat)
