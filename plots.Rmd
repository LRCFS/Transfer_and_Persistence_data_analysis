...
wool.dat = all.ratio %>% filter(Mass == 1000 & Substrate == "Wool")
#wool.dat
...
# plot boxplots
ggplot(all.ratio %>% 
  filter(Substrate != "Denim"), aes(x=Name, y=ratio, fill = Substrate)) +
  geom_boxplot() +
...
ggplot(eff1000.dat[eff1000.dat$Substrate %in% c('Wool', 'Nylon'),], aes(x=numericFactorOrder(TransferTime), y = efficiency, group = Name, colour = Name, shape=Name)) +
  geom_point(size = 2, position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = efficiency-se, ymax = efficiency+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
  labs(title = "Transfer Efficiency",
       subtitle = "For 1000g Mass",
       x = "Transfer Time (s)",
...
ggplot(eff60.dat, aes(x=numericFactorOrder(Mass), y = efficiency, group = Name, colour = Name, shape=Name)) +
  geom_point(position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = efficiency-se, ymax = efficiency+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
  labs(title = "Transfer Efficiency",
