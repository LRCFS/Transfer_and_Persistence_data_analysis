...
```{r countcomp4}
all_counts.dat %>% filter(Substrate == 'Wool') %>%
...
```{r countcomp4}
all_counts.dat %>% filter(Substrate == 'Nylon') %>%
ggplot(aes(x = Set, y = count)) + 
  labs(title = 'Particle Counts Per Photo',
...
```{r countcomp6}
all_counts.dat %>% filter(Substrate == 'Wool', Mass == '1000', TransferTime == '60') %>%
ggplot(aes(x = Set, y = count)) + 
  labs(title = 'Particle Counts Per Photo',
...
```{r countcomp8}
all_counts.dat %>% filter(Substrate == 'Nylon', Mass == '1000', TransferTime == '60') %>%
ggplot(aes(x = Set, y = count)) + 
  labs(title = 'Particle Counts Per Photo',
