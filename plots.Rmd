...
em.dat = em.dat[, -6]
all.dat = rbind(all.dat, data.frame(Name = rep("E",nrow(em.dat)), em.dat))
...
all.final = all.dat %>% group_by(Name, Mass, TransferTime, Experiment, Substrate, Replicate) %>%
...
ggplot(nylon.dat[nylon.dat$TransferTime != '10',], aes(x=numericFactorOrder(TransferTime), y = ratio, group = Name, colour = Name, shape=Name)) +
  geom_point(size = 2, position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = ratio-se, ymax = ratio+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
...
ggplot(nylon.eff.dat[nylon.eff.dat$TransferTime != '10',], aes(x=numericFactorOrder(TransferTime), y = efficiency, group = Name, colour = Name, shape=Name)) +
  geom_point(size = 2, position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = efficiency-se, ymax = efficiency+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
  labs(title = "Transfer Efficiency for Cotton to Nylon",
       subtitle = "For 1000g Mass",
       x = "Transfer Time (s)",
...
wool.eff.dat = all.eff %>% filter(Mass == 1000 & Substrate == "Wool01")
#nylon.eff.dat

ggplot(wool.eff.dat[wool.eff.dat$TransferTime != '10',], aes(x=numericFactorOrder(TransferTime), y = efficiency, group = Name, colour = Name, shape=Name)) +
  geom_point(size = 2, position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = efficiency-se, ymax = efficiency+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
  labs(title = "Transfer Efficiency for Cotton to Wool",
       subtitle = "For 1000g Mass",
       x = "Transfer Time (s)",
       y = "Transfer Efficiency") +
  mytheme
