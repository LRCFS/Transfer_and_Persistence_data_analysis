...
ratio.dat = summarySE(final.dat, measurevar = "Ratio", groupvars = c("Mass","TransferTime","Substrate", "Experiment"))
...
ggplot(wool.eff.dat, aes(x=numericFactorOrder(TransferTime), y = efficiency, group = Name, colour = Name, shape=Name)) +
  geom_point(size = 2, position = position_dodge(0.3)) +
  geom_errorbar(aes(ymin = efficiency-se, ymax = efficiency+se), width = 0.08, position = position_dodge(0.3)) +
  scale_shape_manual(values = c(0, 1, 2, 5, 6)) +
