...
High $P_1$ - background receiver counts - are not the cause of the observed issues with $T_r$ in expt D, but it appears to be when $P_1 \approx P_3$ that results in very high or negative $T_r$ values.
